...
class WinningStatisticsTest {
    ...
    fun `총 당첨 금액을 올바르게 계산해야 한다`() {
        ...
        val expectedTotalPrize = threeMatchedPrize + fourMatchedPrize
        ...
        val totalPrizeMoney = winningStatistics.totalPrizeMoney()

        assertEquals(expectedTotalPrize, totalPrizeMoney)
    }
