...
- 5개 일치하며 보너스볼을 맞으면 2등 

---------------------
해야할 것

- LottoMatcher 를 보너스에 대한 정보를 가지고 있는 Matcher 를 추가  
- LottoMatcher 에서 구매한 로또 티켓을 필드로 추가  
- LottoMatcher 에서 메서드의 인자로 resultLottoTicket 을 받도록 변경
